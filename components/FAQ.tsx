...
const faqs = [
  ...
  },
  {
    ...
    a: "Sim! A boia cevadeira é inclusa no Kit Pesqueiro Superfície sem custo adicional. Ela faz parte da proposta do kit porque é o acessório essencial pra quem pesca na boia em pesqueiro.",
  },
  {
    q: "A linha já vem enrolada no molinete?",
    a: "A linha vem separada para você enrolar do jeito que preferir. Kit Tilápia inclui 100m de brinde. Kits Fundo e Superfície incluem 500m — sobra bastante pra repor quando precisar.",
  },
  {
