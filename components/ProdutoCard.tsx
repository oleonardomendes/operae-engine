...
export default function ProdutoCard({
  ...
  function handleTouchEnd(e: React.TouchEvent) {
    if (touchStartX === null || !temMultiplas) return
  ...
  return (
    <>
      ...
      {produtoHref ? (
        <Link href={produtoHref} className="pcd-img-area" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>{imgAreaInner}</Link>
      ) : (
        <div className="pcd-img-area" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>{imgAreaInner}</div>
      )}
      ...
      <div className="pcd-body">
        ...
        <div className="pcd-actions">
          ...
          <Link href={produtoHref || checkoutHref} className="pcd-btn-comprar">
            Comprar agora
          </Link>
        </div>
      </div>
