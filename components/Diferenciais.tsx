const cards = [
  ...
  {
    title: "Linha de pesca inclusa em todo kit",
    text: "Kit Tilápia vem com linha 100m de brinde. Kits Fundo e Superfície incluem linha monofilamento CMIK 0,35mm com 500m. Chegou, enrolou, foi pescar.",
