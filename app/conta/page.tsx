...
export default async function ContaPage() {
  ...
  const nome = user.user_metadata?.full_name || user.user_metadata?.nome || user.email
            ...
            {pedidos.map(pedido => (
              <div key={pedido.id} style={{ background: '#fff',
                ...
                <div>
                  ...
                  {pedido.me_tracking && (
                    <a
                      href={`https://www.melhorrastreio.com.br/rastreio/${pedido.me_tracking}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ fontSize: '12px', color: 'var(--g500)',
