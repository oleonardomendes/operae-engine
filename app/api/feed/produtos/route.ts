...
function gerarDescricao(nome: string): string {
  const n = nome.toLowerCase()
  let complemento = 'Equipamento de pesca com procedência e qualidade.'

  if (n.includes('vara') && n.includes('molinete')) {
    complemento = 'Vara de pesca para molinete com ótimo desempenho em rios, represas e pesqueiros.'
  } else if (n.includes('vara') && n.includes('carretilha')) {
    complemento = 'Vara de pesca para carretilha, ideal para peixes de médio e grande porte.'
  } else if (n.includes('vara') && n.includes('telescóp')) {
    complemento = 'Vara telescópica prática e resistente, fácil de transportar para qualquer pescaria.'
  } else if (n.includes('vara')) {
    complemento = 'Vara de pesca resistente, indicada para diferentes modalidades e tipos de peixe.'
  } else if (n.includes('molinete')) {
    complemento = 'Molinete de pesca com arraste suave e alta durabilidade para pescarias prolongadas.'
  } else if (n.includes('carretilha')) {
    complemento = 'Carretilha de pesca de alta precisão, ideal para pescadores exigentes.'
  } else if (n.includes('linha') || n.includes('nylon')) {
